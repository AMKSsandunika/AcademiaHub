...
<section class="dashboard">
   ...
   <div class="box">
      <?php
         $select_listings = $conn->prepare("SELECT * FROM `playlist`");
         $select_listings->execute();
         $count_listings = $select_listings->rowCount();
      ?>
      <h3><?= $count_listings; ?></h3>
      <p>property posted</p>
      <a href="all_courses.php" class="btn">View Playlists</a>
   </div>
   ...
   <div class="box">
      <?php
         ...
         $count_tutors = $select_tutors->rowCount();

         $total_users_and_tutors = $count_users + $count_tutors;
      ?>
      <h3><?= $total_users_and_tutors; ?></h3>
      <p>total users and tutors</p>
